...
export const Card = ({
  ...
  return (
    (<div
      className={cn(
        "rounded-2xl h-full w-full p-4 overflow-hidden bg-white border border-black group-hover:border-slate-700 relative z-20",
        className
      )}>
...
export const CardTitle = ({
  ...
  return (
    (<h4 className={cn("text-slate-800 font-bold tracking-wide mt-4", className)}>
      {children}
    </h4>)
  );
};
